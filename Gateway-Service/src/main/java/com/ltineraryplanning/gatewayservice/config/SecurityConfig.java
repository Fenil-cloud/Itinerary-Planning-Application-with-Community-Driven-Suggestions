    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity serverHttpSecurity){
        serverHttpSecurity
                ...
                .authorizeExchange(exchange->
                                exchange.pathMatchers("/eureka/**","/api/v1/auth/login","/api/v1/auth/register/**","/api/v1/auth/verify/**","verify/mobile","/api/v1/auth/getEmailAndFirstName","/api/v1/auth/reset/**")
                                        .permitAll()
